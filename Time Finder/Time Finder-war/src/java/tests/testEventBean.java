...
public class testEventBean extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            eventBean.createEvent(1, "Test" + Math.random(), "TestD", new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + 1000000));
            ...
            eventBean.setAvailable(1, 1, new Date(System.currentTimeMillis()));
